...
macro_rules! apply_number_type {
    ($num_type:expr, $func:ident, [$( $arg:expr ),*]) => {
        match $num_type.number_type() {
            NumberType::ClDouble => apply_t!($func, cl_double, [$( $arg ),*]),
            NumberType::SizeT => apply_t!($func, libc::size_t, [$( $arg ),*]),
            NumberType::ClHalf => apply_t!($func, cl_half, [$( $arg:expr ),*]),
            NumberType::ClChar => apply_t!($func, cl_char, [$( $arg ),*]),
            NumberType::ClChar2 => apply_t!($func, cl_char2, [$( $arg ),*]),
            NumberType::ClChar3 => apply_t!($func, cl_char3, [$( $arg ),*]),
            NumberType::ClChar4 => apply_t!($func, cl_char4, [$( $arg ),*]),
            NumberType::ClChar8 => apply_t!($func, cl_char8, [$( $arg ),*]),
            NumberType::ClChar16 => apply_t!($func, cl_char16, [$( $arg ),*]),
            NumberType::ClUchar => apply_t!($func, cl_uchar, [$( $arg ),*]),
            NumberType::ClUchar2 => apply_t!($func, cl_uchar2, [$( $arg ),*]),
            NumberType::ClUchar3 => apply_t!($func, cl_uchar3, [$( $arg ),*]),
            NumberType::ClUchar4 => apply_t!($func, cl_uchar4, [$( $arg ),*]),
            NumberType::ClUchar8 => apply_t!($func, cl_uchar8, [$( $arg ),*]),
            NumberType::ClUchar16 => apply_t!($func, cl_uchar16, [$( $arg ),*]),
            NumberType::ClShort => apply_t!($func, cl_short, [$( $arg ),*]),
            NumberType::ClShort2 => apply_t!($func, cl_short2, [$( $arg ),*]),
            NumberType::ClShort3 => apply_t!($func, cl_short3, [$( $arg ),*]),
            NumberType::ClShort4 => apply_t!($func, cl_short4, [$( $arg ),*]),
            NumberType::ClShort8 => apply_t!($func, cl_short8, [$( $arg ),*]),
            NumberType::ClShort16 => apply_t!($func, cl_short16, [$( $arg ),*]), 
            NumberType::ClUshort => apply_t!($func, cl_ushort, [$( $arg ),*]),
            NumberType::ClUshort2 => apply_t!($func, cl_ushort2, [$( $arg ),*]),
            NumberType::ClUshort3 => apply_t!($func, cl_ushort3, [$( $arg ),*]),
            NumberType::ClUshort4 => apply_t!($func, cl_ushort4, [$( $arg ),*]),
            NumberType::ClUshort8 => apply_t!($func, cl_ushort8, [$( $arg ),*]),
            NumberType::ClUshort16 => apply_t!($func, cl_ushort16, [$( $arg ),*]),
            NumberType::ClInt => apply_t!($func, cl_int, [$( $arg ),*]),
            NumberType::ClInt2 => apply_t!($func, cl_int2, [$( $arg ),*]),
            NumberType::ClInt3 => apply_t!($func, cl_int3, [$( $arg ),*]),
            NumberType::ClInt4 => apply_t!($func, cl_int4, [$( $arg ),*]),
            NumberType::ClInt8 => apply_t!($func, cl_int8, [$( $arg ),*]),
            NumberType::ClInt16 => apply_t!($func, cl_int16, [$( $arg ),*]),
            NumberType::ClUint => apply_t!($func, cl_uint, [$( $arg ),*]),
            NumberType::ClUint2 => apply_t!($func, cl_uint2, [$( $arg ),*]),
            NumberType::ClUint3 => apply_t!($func, cl_uint3, [$( $arg ),*]),
            NumberType::ClUint4 => apply_t!($func, cl_uint4, [$( $arg ),*]),
            NumberType::ClUint8 => apply_t!($func, cl_uint8, [$( $arg ),*]),
            NumberType::ClUint16 => apply_t!($func, cl_uint16, [$( $arg ),*]),
            NumberType::ClLong => apply_t!($func, cl_long, [$( $arg ),*]),
            NumberType::ClLong2 => apply_t!($func, cl_long2, [$( $arg ),*]),
            NumberType::ClLong3 => apply_t!($func, cl_long3, [$( $arg ),*]),
            NumberType::ClLong4 => apply_t!($func, cl_long4, [$( $arg ),*]),
            NumberType::ClLong8 => apply_t!($func, cl_long8, [$( $arg ),*]),
            NumberType::ClLong16 => apply_t!($func, cl_long16, [$( $arg ),*]),
            NumberType::ClUlong => apply_t!($func, cl_ulong, [$( $arg ),*]),
            NumberType::ClUlong2 => apply_t!($func, cl_ulong2, [$( $arg ),*]),
            NumberType::ClUlong3 => apply_t!($func, cl_ulong3, [$( $arg ),*]),
            NumberType::ClUlong4 => apply_t!($func, cl_ulong4, [$( $arg ),*]),
            NumberType::ClUlong8 => apply_t!($func, cl_ulong8, [$( $arg ),*]),
            NumberType::ClUlong16 => apply_t!($func, cl_ulong16, [$( $arg ),*]),
            NumberType::ClFloat => apply_t!($func, cl_float, [$( $arg ),*]),
            NumberType::ClFloat2 => apply_t!($func, cl_float2, [$( $arg ),*]),
            NumberType::ClFloat3 => apply_t!($func, cl_float3, [$( $arg ),*]),
            NumberType::ClFloat4 => apply_t!($func, cl_float4, [$( $arg ),*]),
            NumberType::ClFloat8 => apply_t!($func, cl_float8, [$( $arg ),*]),
            NumberType::ClFloat16 => apply_t!($func, cl_float16, [$( $arg ),*]),
        }
    }
}
