...
impl<T> KernelArg for DeviceMem<T> where T: Debug {
    unsafe fn as_kernel_arg(&self) -> KernelArgSizeAndPointer {
        // println!("
        // KernelArg for &DeviceMem<T>
        // self: {:?}
        // ", self);
        (
...
//         (
//             std::mem::size_of::<cl_mem>() as size_t,
//             &self.raw_cl_object() as *const _ as *const c_void
//         )
//     }
// }


// impl<T> KernelArg for &KernelReadOnlyMem<T> {
//     unsafe fn as_kernel_arg(&self) -> KernelArgSizeAndPointer {
//         (
//             std::mem::size_of::<cl_mem>() as size_t,
//             self.raw_cl_object() as *const _ as *const c_void
...
// impl<T> KernelArg for &KernelWriteOnlyMem<T> {
//     unsafe fn as_kernel_arg(&self) -> KernelArgSizeAndPointer {
//         (
//             std::mem::size_of::<cl_mem>() as size_t,
//             self.raw_cl_object() as *const _ as *const c_void
...
//             self as *const usize as *const c_void,
//         )
//     }
// }
...
// impl<T> KernelArg for &KernelReadWriteMem<T> {
//     fn as_kernel_arg(&self) -> KernelArgSizeAndPointer {
//         (
...
impl Drop for Kernel {
    fn drop(&mut self) {
        ...
        unsafe{ cl_release_kernel(&self.raw_cl_object()); }
    }
}
